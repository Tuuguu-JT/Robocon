...
void loop() {
  disp();
  if(digitalRead(button[0]) == LOW){useshoot(HIGH);}
  else{useshoot(LOW);}
  if(digitalRead(button[1]) == LOW){lidserv(0);}
  if(digitalRead(button[2]) == LOW){lidserv(90);}
  if(digitalRead(button[3]) == LOW){lidserv(180);}
}
/*------------------------------------------------------------------------Mini Function-------------------------------------------------------------------------*/
/*------------------Lidar Break---------------*/
...
void parallelleft(){while(1){
  ...
  else if(digitalRead(digitalIO[LEFTSW1]) == LOW && digitalRead(digitalIO[LEFTSW2]) == LOW){break;}
}
}
void parallelfront(){while(1){
  if(digitalRead(digitalIO[FRONTSW1]) == LOW && digitalRead(digitalIO[FRONTSW2]) == HIGH){
    while(1){
      maxspeed = 50;
      mot_go(135,255,255);
      if(digitalRead(digitalIO[FRONTSW1]) == LOW && digitalRead(digitalIO[FRONTSW2]) == LOW){break;} 
    }
    maxspeed = maxspeednorm;
    break;
  }
  ...
  else if(digitalRead(digitalIO[FRONTSW1]) == LOW && digitalRead(digitalIO[FRONTSW2]) == LOW){break;}
}
}
/*-----------------Motor Calculation-------------------------*/
