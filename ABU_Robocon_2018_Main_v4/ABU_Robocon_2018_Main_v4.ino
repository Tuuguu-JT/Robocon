...
mot_go(0,116,127);delay(sddel);
mot_go(0,116,127);delay(sddel);
mot_go(25.77,128.81,127);delay(sddel);
mot_go(25.77,128.81,127);delay(sddel);
mot_go(27.35,130.6,127);delay(sddel);
mot_go(28.89,132.48,127);delay(sddel);
mot_go(27.3,139.54,127);delay(sddel);
mot_go(26.22,149.37,127);delay(sddel);
mot_go(26.57,165.47,127);delay(sddel);
mot_go(26.26,167.26,127);delay(sddel);
mot_go(27.2,161.9,127);delay(sddel);
mot_go(25.67,170.86,127);delay(sddel);
mot_go(28.03,174.47,127);delay(sddel);
mot_go(28.03,174.47,127);delay(sddel);
mot_go(29.83,172.9,127);delay(sddel);
mot_go(27.14,179.79,123);delay(sddel);
mot_go(27.16,170.84,123);delay(sddel);
mot_go(28,178.94,127);delay(sddel);
mot_go(29.74,177.37,127);delay(sddel);
mot_go(29.74,177.37,127);delay(sddel);
mot_go(28.26,181.65,127);delay(sddel);
mot_go(29.18,176.39,127);delay(sddel);
mot_go(28.56,179.89,127);delay(sddel);
mot_go(28.26,181.65,127);delay(sddel);
mot_go(28.26,181.65,127);delay(sddel);
mot_go(28.26,181.65,127);delay(sddel);
mot_go(27.11,188.73,127);delay(sddel);
mot_go(27.37,191.43,127);delay(sddel);
mot_go(27.41,182.48,123);delay(sddel);
mot_go(27.1,193.2,127);delay(sddel);
mot_go(26.31,198.56,127);delay(sddel);
mot_go(25.79,197.69,127);delay(sddel);
mot_go(26.04,195.89,127);delay(sddel);
mot_go(26.05,200.36,127);delay(sddel);
mot_go(26.05,200.36,127);delay(sddel);
mot_go(25.54,199.49,127);delay(sddel);
mot_go(25.79,197.69,127);delay(sddel);
mot_go(25.79,197.69,127);delay(sddel);
mot_go(25.32,205.77,127);delay(sddel);
mot_go(25.32,205.77,127);delay(sddel);
mot_go(24.81,204.92,127);delay(sddel);
mot_go(24.81,204.92,127);delay(sddel);
mot_go(24.58,206.74,127);delay(sddel);
mot_go(24.58,206.74,127);delay(sddel);
mot_go(24.58,206.74,127);delay(sddel);
mot_go(24.58,206.74,127);delay(sddel);
mot_go(24.81,204.92,127);delay(sddel);
mot_go(24.81,204.92,127);delay(sddel);
mot_go(24.85,209.39,127);delay(sddel);
mot_go(24.85,209.39,127);delay(sddel);
mot_go(25.08,207.58,127);delay(sddel);
mot_go(24.58,206.74,123);delay(sddel);
mot_go(24.35,208.56,127);delay(sddel);
mot_go(25.84,211.1,127);delay(sddel);
mot_go(25.37,214.71,127);delay(sddel);
mot_go(25.84,211.1,127);delay(sddel);
mot_go(25.85,215.57,127);delay(sddel);
mot_go(24.85,209.39,123);delay(sddel);
mot_go(24.85,209.39,123);delay(sddel);
mot_go(24.85,209.39,127);delay(sddel);
mot_go(24.4,213.03,127);delay(sddel);
mot_go(24.81,204.92,127);delay(sddel);
mot_go(24.35,208.56,127);delay(sddel);
mot_go(24.4,213.03,127);delay(sddel);
mot_go(24.27,223.79,127);delay(sddel);
mot_go(22.93,225.85,127);delay(sddel);
mot_go(21.61,228.04,127);delay(sddel);
mot_go(20.73,237.36,127);delay(sddel);
mot_go(19.75,248.62,127);delay(sddel);
mot_go(20.14,255,127);delay(sddel);
mot_go(19,255,127);delay(sddel);
mot_go(19,255,127);delay(sddel);
mot_go(19.14,255,127);delay(sddel);
mot_go(19.71,254.94,127);delay(sddel);
mot_go(20.14,255,127);delay(sddel);
mot_go(19.56,255,127);delay(sddel);
mot_go(20.97,255,127);delay(sddel);
mot_go(21.46,251.44,127);delay(sddel);
mot_go(21.23,255,127);delay(sddel);
mot_go(22.9,251.85,127);delay(sddel);
mot_go(22.72,253.69,127);delay(sddel);
mot_go(22.72,253.69,127);delay(sddel);
mot_go(23.03,255,127);delay(sddel);
mot_go(21.8,255,127);delay(sddel);
mot_go(21.8,255,127);delay(sddel);
mot_go(23.33,255,127);delay(sddel);
mot_go(23.33,255,127);delay(sddel);
mot_go(23.71,255,127);delay(sddel);
mot_go(22.57,255,127);delay(sddel);
mot_go(23.71,255,127);delay(sddel);
mot_go(24.46,255,127);delay(sddel);
mot_go(24.46,255,127);delay(sddel);
mot_go(23.71,255,127);delay(sddel);
mot_go(24.09,255,127);delay(sddel);
mot_go(24.09,255,127);delay(sddel);
mot_go(24.09,255,127);delay(sddel);
mot_go(24.09,255,127);delay(sddel);
mot_go(23.33,255,127);delay(sddel);
mot_go(23.71,255,123);delay(sddel);
mot_go(23.33,255,127);delay(sddel);
mot_go(23.33,255,127);delay(sddel);
mot_go(22.57,255,127);delay(sddel);
mot_go(23.71,255,123);delay(sddel);
...
mot_go(22.57,255,127);delay(sddel);
mot_go(22.57,255,127);delay(sddel);
mot_go(22.57,255,119);delay(sddel);
mot_go(22.57,255,127);delay(sddel);
mot_go(23.33,255,127);delay(sddel);
mot_go(24.09,255,127);delay(sddel);
mot_go(24.09,255,123);delay(sddel);
mot_go(25.2,255,127);delay(sddel);
mot_go(25.2,255,127);delay(sddel);
mot_go(25.57,255,127);delay(sddel);
mot_go(25.57,255,127);delay(sddel);
mot_go(25.93,255,127);delay(sddel);
mot_go(27.01,255,123);delay(sddel);
mot_go(26.29,255,127);delay(sddel);
mot_go(25.93,255,127);delay(sddel);
mot_go(25.57,255,127);delay(sddel);
mot_go(24.46,255,127);delay(sddel);
mot_go(25.2,255,127);delay(sddel);
...
//mot_go(23.71,255,127);delay(sddel);
//mot_go(22.57,255,127);delay(sddel);
//mot_go(26.77,253.12,127);delay(sddel);
//mot_go(26.77,253.12,127);delay(sddel);
//mot_go(26.77,253.12,123);delay(sddel);
//mot_go(28.77,232.72,127);delay(sddel);
//mot_go(27.63,241.54,127);delay(sddel);
//mot_go(26.77,244.18,127);delay(sddel);
//mot_go(25.52,246.01,127);delay(sddel);
//mot_go(27.61,246.01,127);delay(sddel);
//mot_go(26.32,207.51,127);delay(sddel);
//mot_go(26.26,167.26,127);delay(sddel);
mot_go(0,0,127);delay(sddel);
mot_go(0,0,127);delay(sddel);
mot_go(0,0,127);delay(sddel);
...
mot_go(0,0,127);delay(sddel);
mot_go(0,0,127);delay(sddel);
mot_go(-90,50,127);delay(sddel);
mot_go(-90,54,127);delay(sddel);
mot_go(-90,60,127);delay(sddel);
mot_go(-90,72,127);delay(sddel);
...
mot_go(-90,112,127);delay(sddel);
mot_go(-90,112,127);delay(sddel);
mot_go(-90,128,127);delay(sddel);
mot_go(-90,122,127);delay(sddel);
mot_go(-90,136,123);delay(sddel);
mot_go(-90,140,127);delay(sddel);
